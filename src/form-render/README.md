...
const Search: FC<IProps> = props => {
  const { name, form, onReset, onValuesChange, children, rootData, submitHidden, resetHidden, onSubmit } = props
      ...
      <Form form={form} onValuesChange={onValuesChange}>
        <SearchFormLayout.Row>
          ...
          <SearchFormLayout.Space>
            ...
            {resetHidden ? null : (
              <Form.Item>
                <Button type={submitHidden ? 'primary' : 'default'} onClick={onReset}>
                  重置
                </Button>
              </Form.Item>
            )}
